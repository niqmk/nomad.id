...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    static NSString *menu_list_id = @"MenuListID";
    Menu_Cell *cell = (Menu_Cell *)[tableView dequeueReusableCellWithIdentifier:menu_list_id];
    if(cell == nil) {
        [[NSBundle mainBundle] loadNibNamed:@"Menu+Cell" owner:self options:nil];
        cell = self.menu_cell;
    }
    if(menu_state == MenuMaster) {
